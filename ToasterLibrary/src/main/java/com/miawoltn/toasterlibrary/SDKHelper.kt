    ...
    fun initFaceMatch(
        ...
        try {
            IdentyFaceSdk.newInstance(
                ...
                object : InitializationListener<IdentyFaceSdk> {
                    override fun onInit(d: IdentyFaceSdk) {
                        d.isDisplayImages = displayImages
...
//    fun processFace(onProcessFace: OnProcessFace) {
//        val bitmap = this.capturedFaceBitmap() ?: return
...
//        val image = InputImage.fromBitmap(editedBitmap, 0)
...
//        faces.addOnSuccessListener { faceList ->
//            if(faceList == null || faceList.isEmpty()) {
//                onProcessFace.onError("No Face Detected. Capture again")
//                return@addOnSuccessListener
//            }else if(faceList.size > 1) {
//                onProcessFace.onError("More than one face detected. Capture again.")
//            }else {
//                val face = faceList[0]
//                if((face.leftEyeOpenProbability!! < 0.7) || (face.rightEyeOpenProbability!! < 0.7)) {
//                    onProcessFace.onError("Eyes not fully Opened. Capture again.")
//                }else if(calculateBrightness(editedBitmap).toFloat().roundToInt() <= 39) {
//                    onProcessFace.onError("Facial Brightness too Low. Capture again")
//                }else {
//                    onProcessFace.onSuccess()
//                }
//            }
//        }.addOnFailureListener {
//            it.message?.let { it1 -> onProcessFace.onError(it1) }
//        }
//    }
